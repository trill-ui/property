...
<head>
    ...
    <style>
        html {
            background: url("statics/bg3.jpg") top center no-repeat;
...
<div class="content" id="rrapp" style="padding: 0">
    ...
    <form class="login-form" method="post" onsubmit="return false">
        ...
        <div class="form-group text-center">
            ...
            <a class="btn btn-link" href="login.jsp" style="position: absolute;right: 20px;">返回登录</a>
        </div>
    </form>
</div>
